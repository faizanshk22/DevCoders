    ...
    <div className="w-full min-h-screen bg-[#1e1e22] flex flex-col items-center py-10">
      ...
      <div className="content-container w-full flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 lg:px-20 mt-10 lg:mt-20">
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ type: 'spring', stiffness: 50 }}
          className="text-container w-full lg:w-1/2 font-['Founders_Grotesk_X-Condensed'] text-white text-lg sm:text-xl md:text-2xl lg:text-3xl"
        >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ type: 'spring', stiffness: 50 }}
          className="icon-container w-full lg:w-1/2 flex items-center justify-center mt-10 lg:mt-0"
        >
          <img
