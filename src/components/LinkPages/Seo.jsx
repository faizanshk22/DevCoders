  ...
  return (
    <div className="w-full min-h-screen bg-[#000] flex flex-col items-center py-10">
      <motion.span 
        ...
        className="title text-[#61DAFB] text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-20 ml-4 sm:mt-24 md:mt-32 lg:mt-40"
      >
      ...
      >
        <div className="text-container w-full lg:w-1/2 font-['DM_sans'] text-white text-lg sm:text-xl md:text-2xl lg:text-3xl mb-10">
