...
function Mobile() {
  return (
    <div className="w-full min-h-screen bg-[#1e1e22] flex flex-col items-center py-13">
      ...
      >
        <div className="text-container w-full lg:w-1/2 font-['DM_sans'] text-white text-lg sm:text-xl mb-10 md:text-2xl lg:text-3xl">
        ...
        <div className="icon-container w-full lg:w-1/2 flex items-center justify-center mb-10 mt-10 lg:mt-0">
          <img
